    ...
    <header class="header" id="header">
        <nav class="nav container primary-navigation">
            <a href="#" class="nav__logo "><img src="img/logoBlackMode.png" alt="">JCLothes</a>
    ...
    <div class="cart" id="cart">
        ...
        <div class="cart__container">
            <article class="cart__card">
                <div class="cart__box">
                    <img src="img/product/tshirtDesign.png" alt="" class="cart__img">
                </div>
            ...
            <article class="cart__card">
                <div class="cart__box">
                    <img src="img/product/satoru.png" alt="" class="cart__img">
                </div>
            ...
            <article class="cart__card">
                <div class="cart__box">
                    <img src="img/product/Longsleeves.png" alt="" class="cart__img">
                </div>
        ...
        <section class="home" id="home">
            <div class="home__container container grid">
                <div class="home__img-bg">
                    <img src="img/product/satoru.png" alt="PageHome" class="home__img">
                </div>
        ...
        <section class="featured section container" id="Design">
            ...
            <div class="featured__container grid">
                <article class="featured__card">
                    ...
                    <img src="img/product/tshirtDesign.png" class="featured__img">
                ...
                <article class="featured__card">
                    ...
                    <img src="img/product/Longsleeves.png" alt="" class="featured__img">
                ...
                <article class="featured__card">
                    ...
                    <img src="img/product/hoodieDesign.png" class="featured__img">
        ...
        <section class="story section container">
            <div class="story__container grid">
                ...
                <div class="story__images">
                    <img src="img/product/satoru.png" alt="" class="story__img">
        ...
        <section class="products section container" id="products">
            ...
            <div class="products__container grid">
                <article class="products__card">
                    <img src="img/product/satoru.png" alt="" class="products__img">
                ...
                <article class="products__card">
                    <img src="img/product/hoodieGojo.png" alt="" class="products__img">
                ...
                <article class="products__card">
                    <img src="img/product/varsity.png" alt="" class="products__img">
                ...
                <article class="products__card">
                    <img src="img/product/MOON1.png" alt="" class="products__img">
                ...
                <article class="products__card">
                    <img src="img/product/ghostrideHoodie.png" alt="" class="products__img">
                ...
                <div class="swiper new-swiper">
                    <div class="swiper-wrapper">
                        <article class="new__card swiper-slide">
                            ...
                            <img src="img/product/satoru.png" alt="" class="new__img">
                        ...
                        <article class="new__card swiper-slide">
                            ...
                            <img src="img/product/EARTH1.png" alt="" class="new__img">
                        ...
                        <article class="new__card swiper-slide">
                            ...
                            <img src="img/product/hoodieTampakBelakang.png" class="new__img">
